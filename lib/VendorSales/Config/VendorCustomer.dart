                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Divider(),
                            _buildLabelValueRow('MailId:', MailId),
                            Divider(),
                            _buildLabelValueRow('Commision :', Commision),
                            SizedBox(height: 10),
                            _buildActionButtons(data, Name, Address, Contact,
                                MailId, Commision),
                          ],
                        ),
                      );
...
// Function to build action buttons
  Widget _buildActionButtons(Map<String, dynamic> data, String Name,
      String Address, String Contact, String MailId, String Commision) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        IconButton(
          ...
          onPressed: () {
            ...
            _emailController.text = MailId;
            _CommisionController.text = Commision;
            isUpdateMode = true;
          },
        ),
        IconButton(
          ...
          onPressed: () {
            vendorId = data['id'].toString();
            _showDeleteConfirmationDialog(vendorId, Name);
          },
        ),
      ],
    );
