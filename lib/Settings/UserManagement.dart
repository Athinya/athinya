                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: Responsive.isDesktop(context)
                                                                            ? Column(
                                                                                ...
                                                                                children: [
                                                                                  Icon(Icons.production_quantity_limits, size: 20.0, color: iconColor),
                                                                                  SizedBox(height: 4.0),
                                                                                  Text(item['submenu'] ?? '', style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w500, color: textColor), textAlign: TextAlign.center),
                                                                                ],
                                                                              )
                                                                            : Row(
                                                                                children: [
                                                                                  SizedBox(width: 15.0),
                                                                                  Icon(Icons.production_quantity_limits, size: 15.0, color: iconColor),
                                                                                  SizedBox(width: 4.0),
                                                                                  SingleChildScrollView(
                                                                                    scrollDirection: Axis.horizontal,
                                                                                    child: Container(
                                                                                      child: Text(item['submenu'] ?? '', style: TextStyle(fontSize: 12.0, fontWeight: FontWeight.w500, color: textColor), textAlign: TextAlign.start),
                                                                                    ),
                                                                                  ),
                                                                                ],
                                                                              ),
