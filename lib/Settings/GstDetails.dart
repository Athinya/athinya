...
class _GstDetailsFormState extends State<GstDetailsForm> {
  ...
  Widget _buildListItem(Map<String, dynamic> data) {
    ...
    var gst = data['gst'] ?? 'NonGst';
    var Productid = data['id'].toString();

    // Determine the image asset based on the name
    String imagePath;
    switch (name) {
      case 'Sales':
      ...
      case 'OrderSales':
        ...
        break;
      case 'Purchase':
        imagePath = 'assets/imgs/purchaseimg.png';
        break;
      case 'VendorSales':
        imagePath = 'assets/imgs/ordersales.png';
        break;
      default:
