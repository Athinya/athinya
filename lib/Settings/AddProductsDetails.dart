                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelText: 'RetailAmount(TakeAway)',
                          labelStyle: commonLabelTextStyle.copyWith(
                            color: const Color.fromARGB(255, 116, 116, 116),
                          ),
                          enabledBorder: OutlineInputBorder(
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: RichText(
                    text: TextSpan(
                      style: commonLabelTextStyle.copyWith(fontSize: 14),
                      children: [
                        TextSpan(
                          text: 'Stock Check: ',
                          style: TextStyle(
                      ...
                      child: Row(
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 159, 207, 247),
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color:
                                      const Color.fromARGB(255, 159, 207, 247),
                                  borderRadius: BorderRadius.circular(5),
                                  boxShadow: [
                                    BoxShadow(
                                      color: Colors.grey.withOpacity(0.2),
                ...
                child: Column(children: [
                  ...
                  if (getFilteredData().isNotEmpty)
                    ...getFilteredData().map((data) {
                      ...
                      String? base64Image =
                          data['image']; // Assuming this is your base64 string
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border(
                                      ...
                                      // No left border, so omit it
                                    ),
                                  ),
                                  child: CircleAvatar(
                                    radius:
                                        15.0, // Increase the radius to fit the image size
