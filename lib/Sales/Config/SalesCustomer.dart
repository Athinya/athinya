                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Flexible(
                                // Ensure the container doesn't overflow by making it flexible
                                child: Padding(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          staffform(), // This is your form widget
                                        ],
                                      ),
                                    ),
                                  ),
                                  ...
                                  SingleChildScrollView(
                                    ...
                                    child: Container(
                                      width: MediaQuery.of(context).size.width *
                                          0.86, // Make sure it fits screen width
                                      child:
                                          tableView(), // Your table view widget
                                    ),
                                  ),
                                ],
                              ),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(
              ...
              Icons.feed_outlined,
              FeedBackFocusNode,
              OpenBalanceFocusNode,
            ),
            SizedBox(height: 20.0),
            _buildTextField(
              "Opening Balance",
              openingbalancezController,
              200,
              Icons.balance,
              OpenBalanceFocusNode,
              saveButtonFocusNode,
          ...
          Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                labelText: label, // Use label as a placeholder
                ...
                return SingleChildScrollView(
                  ...
                  child: Wrap(
                    ...
                    children: List.generate(getFilteredData().length, (index) {
                      ...
                      var dateofbirth = data['dateofbirth'].toString();
                      var marriagedt = data['marriagedt'].toString();
                      var opnamnt = data['opnamnt'].toString();
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10),
                            _buildLabelValueRow('Name:', cusname),
                            Divider(),
                            _buildLabelValueRow('Address:', address),
                            Divider(),
                            _buildLabelValueRow('Contact:', contact),
                            Divider(),
                            _buildLabelValueRow('Email Id:', mailid),
                            Divider(),
                            _buildLabelValueRow('Feedback:', feedback),
                            Divider(),
                            _buildLabelValueRow('Points:', Points),
                            Divider(),
                            _buildLabelValueRow('DOB:', dateofbirth),
                            Divider(),
                            _buildLabelValueRow('MrgDt:', marriagedt),
                            Divider(),
                            _buildLabelValueRow('Opening Balance :', opnamnt),
                            SizedBox(height: 10),
                            _buildActionButtons(
                                data,
                                cusname,
      ...
      children: [
        IconButton(
          ...
          onPressed: () {
            ...
            _CustomerNameController.text = cusname;
            _addressController.text = address;
            _contactController.text = contact;
            _Emailidcontrolller.text = mailid;
            _feedbackController.text = feedback;

            setState(() {
              selectedBirthDate = dateofbirth; // Ensure to set state here
              selectMarriageDate = marriagedt; // Ensure to set state here
              openingbalancezController.text = opnamnt;
              isUpdateMode = true;
            });
        ...
        IconButton(
          ...
          onPressed: () {
            customerid = data['id'].toString();
            _showDeleteConfirmationDialog(customerid, cusname);
          },
        ),
      ],
    );
