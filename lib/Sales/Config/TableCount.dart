                    ...
                    return SingleChildScrollView(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            // Table Count Settings Container
                            Container(
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    SizedBox(height: 5.0),
                                    // Table View with Scrollable Height
                                    SingleChildScrollView(
                                      ...
                                      child: Container(
                                        height: MediaQuery.of(context)
                                                .size
                                                .height *
                                            0.55, // Fixed height for the table view
                                        child:
                                            tableView(), // Call the tableView widget
                                      ),
                                    ),
                                    SizedBox(
                                        height:
                                            10), // Space for pagination controls
                                    Padding(
              ...
              if (getFilteredData().isNotEmpty)
                ...getFilteredData().map((data) {
                  ...
                  Color? rowColor = isEvenRow
                      ? Color.fromARGB(223, 239, 237, 237)
                      ...
                      child: Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            ...
                            children: [
                              // Left side: Table Icon, Name, and Count

                              Padding(
                                padding: EdgeInsets.only(
                                    left: isDesktop ? 20.0 : 10.0),
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    Image.asset(
                                    ...
                                    SizedBox(
                                        width:
                                            15), // Reduced space between icon and text
                                    Column(
                                      crossAxisAlignment:
                              ...
                              // Right side: Action buttons and Code
                              Padding(
                                padding: EdgeInsets.only(
                                    right: isDesktop ? 10.0 : 2.0),
                                child: Column(
                                  children: [
                                    Row(
                                      children: [
                                    ...
                                    SizedBox(
                                        height:
                                            2), // Reduced space between actions and code
                                    Text(
                                      "Code: $code",
                                      style: TextStyle(
                                          fontSize: 12), // Reduced font size
