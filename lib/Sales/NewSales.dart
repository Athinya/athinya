...
import 'package:ProductRestaurant/Sales/SubTableSales.dart';
...
import 'package:ProductRestaurant/Sales/SubFormNewSales.dart';
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child:
                        SalesTypeDropdown(), // Use the modified dropdown here
                  ),
                ),
              ],
            ),
                  ...
                  SingleChildScrollView(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child:
                            CustomerNameDropdown(), // Use the modified dropdown here
                      ),
                    ),
                  ),
                ],
          ...
          Expanded(
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Container(
                  color: Color.fromRGBO(254, 247, 255, 10),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          Container(
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.only(
                                    top: Responsive.isDesktop(context) ? 8 : 14,
                                    left:
                                                                        ...
                                                                        IconButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            setState(() {
                                                                              ...
                                                                              isSaleOn = true; // Update any UI state you want without resetting the timer
                                                                            });
                                                                          },
                                                                        ),
                                                                      ],
                          ...
                          if (Responsive.isDesktop(context))
                            Container(
                                child: finalamount(
                                    finalAmount: finalAMTcontroller)),
                          Container(
                            width: Responsive.isDesktop(context)
