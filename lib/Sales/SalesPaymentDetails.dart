...
class _SalesPaymetdetailsState extends State<SalesPaymetdetails> {
        ...
        children: [
          ...
          Container(
            ...
            child: Padding(
              ...
              child: CustomerNameDropdown(), // Use the modified dropdown here
            ),
          ),
          Padding(
                      ...
                      child: LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          double dialogHeight = constraints.maxHeight *
                              0.9; // Height remains 90% for all views
                          if (constraints.maxWidth < 600) {
                            // For mobile view, set width to 90% of the screen width
                            dialogWidth = constraints.maxWidth * 0.9;
                          } else {
                            // For tablet/desktop view, increase width to 80% or 90% of the screen width
                            dialogWidth = constraints.maxWidth *
                                0.9; // Change this to 0.9 for wider dialog
                          }

                          return Container(
                            width: dialogWidth, // Dynamically adjust width
                            height: dialogHeight, // Dynamically adjust height
                            padding: EdgeInsets.all(
                                16), // Padding around the content
                            child: Stack(
                              children: [
                                SalesCoutomer(), // Your custom widget for the dialog content
                                Positioned(
                                  right: 0.0,
                                  top: 0.0,
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      fetchCUstomerName(); // Your custom method
                                    },
                                  ),
                                ),
                              ],
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      ...
                      child:
                          Paymenttypedropdown(), // Use the modified dropdown here
                    ),
                  ),
                  // Container(
                  //     height: 23,
            ...
            Container(
              ...
              child: Wrap(
                ...
                children: [
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: buildTextField(
                              ...
                              null,
                              isReadOnly:
                                  true, // Set the text field to read-only
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        left: Responsive.isDesktop(context) ? 5 : 10, top: 8.0),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                      ...
                      children: [
                        Padding(
                          ...
                          child: buildTextField(
                              ...
                              ContactFocuNode,
                              BalanceFocuNode,
                              isReadOnly: true, onChangedCallback: (newValue) {
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        top: Responsive.isMobile(context) ? 10.0 : 10.0,
                              ...
                              children: [
                                Container(
                                  height: Responsive.isMobile(context)
                                      ? 40
                                      : 40, // Adjust height for mobile view // Adjust height for proper alignment
                                  decoration: BoxDecoration(
                                    boxShadow: [
                                      BoxShadow(
                                        color: Colors.grey.withOpacity(0.15),
                                      ...
                                      Expanded(
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment
                                              .start, // Aligns the label and input to the start
                                          children: [
                                            Text(
                                              'Date', // Label for the date picker
                                              style: TextStyle(
                                                color: Colors.black87,
                                                fontSize:
                                            ...
                                            Container(
                                              height: Responsive.isMobile(
                                                      context)
                                                  ? 15
                                                  : 8, // Adjust height for mobile view // Adjust height for proper alignment
                                              child: DateTimePicker(
                                                ...
                                                dateLabelText:
                                                    '', // You can also keep this if you want to use it
                                                onChanged: (val) {
                                                  // Update selecteddt when the date is changed
                                                  setState(() {
                                                    selecteddt =
                                                        DateTime.parse(val);
                                                    // Update the controller text to show the selected date
                                                    DateController.text =
                                                        val; // Display selected date in the text field
                                                  });
                                                  print(val);
                                                },
                                                validator: (val) {
                                                ...
                                                style:
                                                    textStyle, // Set the text style for the date picker
                                                textInputAction:
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        left: Responsive.isDesktop(context) ? 5 : 10.0,
                        top: Responsive.isMobile(context) ? 0 : 10.0),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        left: Responsive.isDesktop(context) ? 5 : 10,
                        top: Responsive.isDesktop(context) ? 8.0 : 0.0),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(
                              left: Responsive.isDesktop(context) ? 7 : 10),
                          child: Container(
                            width: Responsive.isDesktop(context)
                                ? MediaQuery.of(context).size.width * 0.13
                                : MediaQuery.of(context).size.width * 0.47,
                            child: Row(
                              children: [
                                ...
                                Container(
                                  height:
                                      40, // Adjust height for proper alignment
                                  decoration: BoxDecoration(
                                    boxShadow: [
                                      BoxShadow(
                                        color: Colors.grey.withOpacity(0.15),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              'Cheque / Cash Dt', // Label for the date picker
                                              style: TextStyle(
                                                color: Colors.black87,
                                                fontSize:
                                                    11, // Adjust the font size as needed
                                            ...
                                            Container(
                                              height: Responsive.isDesktop(
                                                      context)
                                                  ? 8
                                                  : 15, // Adjust height for proper alignment
                                              child: DateTimePicker(
                                                controller:
                                                    ChequeCashDtController,
                                                focusNode:
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        left: Responsive.isDesktop(context) ? 5 : 10.0, top: 0),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        top: 0, left: Responsive.isDesktop(context) ? 5 : 5.0),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                          ...
                          child: buildTextField(
                              ...
                              Responsive.isDesktop(context)
                                  ? MediaQuery.of(context).size.width *
                                      0.12 // Width for desktop
                                  : MediaQuery.of(context).size.width *
                                      0.47, // Width for mobile
                              Icons.attach_money_rounded,
                              AmountFocusNode,
                              saveButtonFocusNode, onChangedCallback: (value) {
                            checkBalance();
                          }, context: context),
                          // child: Container(
                          //   width: Responsive.isDesktop(context)
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        left: Responsive.isDesktop(context) ? 5 : 10,
                        top: Responsive.isDesktop(context) ? 8.0 : 10),
  ...
  void AmountWarningMessage(context) {
    showDialog(
      barrierDismissible: false,
      context: context,
      builder: (BuildContext context) {
