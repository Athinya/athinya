                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      //     ),
                      //     SizedBox(
                      //         height: 10), // Add spacing between From and To
                      //     // 'To' Date Picker
                      //     Padding(
                      //       padding: const EdgeInsets.only(left: 5.0),
                      //       child: Column(
                      ...
                      Padding(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                // For desktop/tablet views: Row layout with Total Sales and Export button in the same row
                                ...
                                // For mobile view: Stack vertically with Total Sales on top and Export button below
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          width: MediaQuery.of(context)
                                                  .size
                                                  .width *
                                              0.8, // Full width for mobile view
                                            ...
                                            child: Container(
                                              ...
                                              child: ElevatedButton(
                                                ...
                                                child: Row(
                                                  mainAxisAlignment:
                                                      MainAxisAlignment
                                                          .end, // Center the button for mobile view
                                                  children: [
                                                    Padding(
                                                      padding:
                                                          const EdgeInsets.only(
