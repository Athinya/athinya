...
class _PurchaseCustomerSupplierState extends State<PurchaseCustomerSupplier> {
  ...
  FocusNode _openBalFocusNode = FocusNode();
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10),
                            _buildLabelValueRow('Name:', name),
                            Divider(),
                            _buildLabelValueRow('Contact:', contact),
                            Divider(),
                            _buildLabelValueRow('Address:', address),
                            Divider(),
                            _buildLabelValueRow('GST No:', gstno),
                            Divider(),
                            _buildLabelValueRow('Opening Balance:', balance),
                            SizedBox(height: 10),
                            _buildActionButtons(
                                data, name, gstno, address, contact, balance),
                          ],
                        ),
                      );
                    }),
...
// Function to build action buttons
  Widget _buildActionButtons(Map<String, dynamic> data, String name,
      String gstno, String address, String contact, String balance) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        IconButton(
          ...
          onPressed: () {
            ...
            _supplierAddressController.text = address;
            _supplierContactController.text = contact;
            _suppliergstNoController.text = gstno;
            _supplieropenBalanceController.text = balance;
        ...
        IconButton(
          ...
          onPressed: () {
            supplierid = data['id'].toString();
            _showDeleteConfirmationDialog(supplierid, name);
          },
        ),
      ],
    );
