    ...
    child: MouseRegion(
      ...
      child: Column(
        ...
        children: [
          Container(
            height:
                height ?? 35, // Set a default height or use the provided height
            ...
            child: TextFormField(
              ...
              onChanged: isReadOnly
                  ? (value) {
                      if (onChangedCallback != null) {
                        onChangedCallback(controller.text);
                      }
                    }
                  : (value) {
                      if (onChangedCallback != null) {
              ...
              decoration: InputDecoration(
                ...
                filled: true, // Ensures that the background color is applied
                fillColor: (currentFocusNode?.hasFocus ?? false)
                ...
                enabledBorder: OutlineInputBorder(
                  borderSide: BorderSide(
                    color: enableColor ?? Colors.grey.shade300,
                ...
                contentPadding: EdgeInsets.symmetric(
                  vertical: 12.0, // Adjust this value to control the height
                  horizontal: 10.0,
                ),
              ),
