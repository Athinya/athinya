...
//
  ...
  void showTableSalesDialog(List<dynamic> tableCounts) {
    showDialog(
      context: context,
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: tableCounts.map<Widget>((data) {
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: List.generate(count, (index) {
                        String tableId =
                            '$code${index + 1}'; // Generate table ID
                        return GestureDetector(
                          onTap: () {
                            tableNumberController.text =
                                tableId; // Set the text field value
